...
/**
 * Executes revocation of STS temporary secrets (tokens).
 *
...
@Command(name = "revokeststoken",
    description = "Revoke S3 STS temporary token for the given access key id")
public class RevokeS3TemporarySecretHandler extends S3Handler {
  ...
  protected void execute(OzoneClient client, OzoneAddress address)
    ...
    client.getObjectStore().revokeS3TemporarySecret(accessKeyId, sessionToken);
