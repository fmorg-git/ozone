...
/**
 * Response for RevokeS3TemporarySecret request.
 */
@CleanupTableInfo(cleanupTables = {S3_REVOKED_STS_TOKEN_TABLE})
public class S3RevokeTemporarySecretResponse extends OMClientResponse {

  private final String accessKeyId;
  private final String sessionToken;

  public S3RevokeTemporarySecretResponse(@Nullable String accessKeyId,
  ...
  public void addToDBBatch(OMMetadataManager omMetadataManager,
    ...
    if (accessKeyId != null
      ...
      if (table != null) {
        // Store sessionToken as value if present, otherwise empty string
        table.putWithBatch(batchOperation, accessKeyId,
